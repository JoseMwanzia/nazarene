...
<div className="gc_partner_main_wrapper">
	<div className="container">
		<div className="row">
			<div className="col-lg-12 col-lg-12 col-lg-12 col-lg-12">
				<div className="gc_partner_heading_wrapper">
					<div className="gc_partner_heading">
						<h2>Sponsors</h2>
			...
			<div className="col-lg-12 col-lg-12 col-lg-12 col-lg-12">
				<div className="gc_partner_slider_wrapper">
					...
					<div className="item">
						...
						<div className="gc_prt2_img_wrapper">
							<img src="images/content/logo02.png" alt="partner_img"/>
						</div>
						<div className="gc_prt3_img_wrapper">
							<img src="images/content/logo03.png" alt="partner_img"/>
						</div>
						<div className="gc_prt4_img_wrapper hidden-xs">
							<img src="images/content/logo04.png" alt="partner_img"/>
						</div>
						<div className="gc_prt5_img_wrapper hidden-sm hidden-xs">
							<img src="images/content/logo05.png" alt="partner_img"/>
						</div>
						<div className="gc_prt1_img_wrapper hidden-xs">
							<img src="images/content/logo03.png" alt="partner_img"/>
						</div>
						<div className="gc_prt2_img_wrapper hidden-xs">
							<img src="images/content/logo07.png" alt="partner_img"/>
						</div>
						<div className="gc_prt3_img_wrapper hidden-xs">
							<img src="images/content/logo01.png" alt="partner_img"/>
						</div>
						<div className="gc_prt4_img_wrapper hidden-xs">
							<img src="images/content/logo03.png" alt="partner_img"/>
